...
<?php 
	...
	$sql="SELECT * FROM turma WHERE id_turma='$idturma'";
	$get=mysqli_query($con,$sql);
	
	$linha = mysqli_fetch_assoc($get);
	
	$turma = $linha['num_turma'];
	$turno = $linha['turno_turma'];
	$naluno = $linha['num_alu_turma'];
	$matricula_prof = $linha['matricula_prof_turm'];
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Turma
        <small>ateração de turma</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../inicio.php"><i class="fa fa-dashboard"></i> Início</a></li>
        <li><a href="buscar_turma.php">Turma</a></li>
      ...
      <div class="row">
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Altere esta turma</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="alterarturma.php" id="form" method="POST" class="form-horizontal">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" name="Turma" class="form-control" id="turma" placeholder="Nome/número turma" value="<?php echo $turma ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" name="Turno" class="form-control" id="turno" placeholder="Turno" value="<?php echo $turno ?>">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="number" name="NumAlu" class="form-control" id="nalunos" placeholder="N°" style="width:100px;" value="<?php echo $naluno ?>">
                  </div>
                  </div>
                <div class="form-group">                                  
			...
			<select type="text" name="MatriculaProf" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="width:100%;">
		        <?php 
			$result= mysqli_query($con,'SELECT * FROM professor ORDER BY id_professor ASC'); ?>
			<?php while($row= mysqli_fetch_assoc($result)) { ?>
		    	<option value="<?php echo $row['matricula_prof'] ?>" <?php if ($row['matricula_prof']==$matricula_prof ) { ?>selected="selected"<?php } ?>>
			<?php echo htmlspecialchars($row['nome_prof']); ?>
			</option>
			<?php 
		    	} 
	    		?>
              ...
              <div class="box-footer">
                ...
                <button type="button" onclick="alerta1()" class="btn btn-success pull-right">Alterar</button>
              </div>
              <!-- /.box-footer -->
            </form>  
	</div>
...
if(typeof window.history.replaceState== 'function') {
        window.history.replaceState({}, "Hide", "http://athena.troiatecnologia.com.br/new_sistem/pages/class/alterar_turma.php");
}		
</script>
</body>
</html>
