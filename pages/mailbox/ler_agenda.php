...
include_once '../../dist/php/cachelogin_la.php';
...
//Aqui recebe tudo que vem da agenda
	...
	$visu = $linhare['visu'];
	$era = $linhare['email_resp_agenda'];
	$naluno = $linhare['nome_aluno'];
	$turma = $linhare['turma_aluno'];
	$matalu = $linhare['matricula_alu_agen'];					
	// da update na visualização
	$query = mysqli_query($con, "UPDATE agenda SET visu='1' WHERE id_agen='$id'");
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h5><b>De:</b> <?php echo $era ."</br><b>Responsável pelo:</b> ". $naluno . "</br><b>Turma:</b> " . $turma ?> 
...
if(typeof window.history.replaceState == 'function') {
        window.history.replaceState({}, "Hide", "http://athena.troiatecnologia.com.br/new_sistem/pages/mailbox/ler_agenda.php");
}     		
</script>
</body>
</html>