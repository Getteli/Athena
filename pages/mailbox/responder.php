...
<?php
	...
	$sqlre = "SELECT * FROM aluno WHERE matricula_alu = '$matalu'";
	$dadosre = mysqli_query($con,$sqlre);	
	
	$linhare = mysqli_fetch_assoc($dadosre);
	
	$nome = $linhare['nome_alu'];
	$turma = $linhare['turma_fk'];	
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Responda a esta agenda</h3>
            </div>
            <!-- /.box-header -->	
            <div class="box-body">                  
            <form action="salvaragenda.php" method="post" id="form">            
              <div class="form-group">
                <input class="form-control" name="usu" placeholder="Para:" value="<?php echo $nome ?>">
                <input type="hidden" class="form-control" name="termo_aluno" placeholder="Para:" value="<?php echo $matalu ?>">
	      </div>
	      <div class="form-group">
                <input class="form-control" name="usu2" placeholder="Da turma:" value="<?php echo $turma?>">              	      
	      </div>
              <div class="form-group">
...
if(typeof window.history.replaceState == 'function') {
        window.history.replaceState({}, "Hide", "http://athena.troiatecnologia.com.br/new_sistem/pages/mailbox/responder.php");
}     		
</script>
</body>
</html>