...
include_once '../../dist/php/info.php';
	...
	$mensagem = filter_input(INPUT_POST, "msg");
        $aluno = filter_input(INPUT_POST, "termo_aluno");
 ...
 if(empty($aluno) && empty($turma)){        
	...
	if ($con) {
		...
		die("Erro: ".mysql_error($con));
	        ...
	        include_once '../../dist/php/sendMultiplePush.php';
	
	        
}else if($turma && empty($aluno)){


	// verificar a conexao, se tudo estiver certo, vai executar a linha e enviar o novo registro, se nao vai informar qual o erro
	if ($con) {
		$query = mysqli_query($con, "insert into agenda(titulo_agen,mensagem_age,remedio1,dosagem1,horario1,remedio2,dosagem2,horario2,remedio3,dosagem3,horario3,colacao,almoco,lanche,janta,sono,evacuacao,evacuacaox,nome_aluno,turma_aluno) values('$titulo','$mensagem','turmaagendasistema','3','3','3','3','3','3','3','3','3','3','3','3','3','3','3','3','$turma')");
			if ($query) {
					echo "<script type='text/javascript'>					
					$.confirm({
					    title: 'Sucesso!',
		...
		die("Erro: ".mysql_error($con));
	        ...
	        include_once '../../dist/php/sendMultiplePushTurma.php';
	...
	if ($con) {
		...
		die("Erro: ".mysql_error($con));
	        ...
	        include_once '../../dist/php/sendSinglePushAgenda.php';
