...
if (is_numeric($parametro) || !empty($mes) || !empty($dia) || !empty($ano)) {
	...
	$get = "SELECT * from agenda WHERE NOT remedio1 = '1' AND lixo = '0' AND matricula_alu_agen='$parametro' OR matricula_prof_agen='$parametro' AND NOT remedio1 = '1' AND lixo = '0' OR MONTH(data_agen) = '$mes' AND NOT remedio1 = '1' AND lixo = '0' OR DAY(data_agen) = '$dia' AND NOT remedio1 = '1' AND lixo = '0' OR YEAR(data_agen) = '$ano' AND NOT remedio1 = '1' AND lixo = '0' ORDER BY id_agen DESC";
	...
	$get = "SELECT * from agenda WHERE NOT remedio1 = '1' AND lixo = '0' AND matricula_alu_agen='$matr' OR matricula_prof_agen='$matrP' AND NOT remedio1 = '1' AND lixo = '0' OR titulo_agen like '%$parametro%' AND NOT remedio1 = '1' AND lixo = '0' OR mensagem_age like '%$parametro%' AND NOT remedio1 = '1' AND lixo = '0' OR MONTH(data_agen) = '$mes' AND NOT remedio1 = '1' AND lixo = '0' OR DAY(data_agen) = '$dia' AND NOT remedio1 = '1' AND lixo = '0' OR YEAR(data_agen) = '$ano' AND NOT remedio1 = '1' AND lixo = '0' ORDER BY id_agen DESC";

}else{
	//assim que inicia, como não tem parametro, ele busca tudo
	$get = "SELECT * FROM agenda WHERE NOT remedio1 = '1' AND lixo = '0' ORDER BY id_agen DESC";
}
      ...
      <div class="row">
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="diaadia.php"><i class="fa fa-file-text-o"></i> Dia a dia <i class="fa fa-exclamation text-yellow"></i></a></li>
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 id="red-tit" class="box-title">Dia a dia</h3>
...
return	$.confirm({
title: 'Agenda',
content: 'Prosseguir com a Exclusão destas mensagens? </br><h5>obs: excluir todas as mensagens também excluirá as mensagens da pasta <b>enviados</b></h5>',
buttons: {
excluir: {
text: 'excluir TUDO',
btnClass: 'btn-red',
action: function (){
window.location = "lixo_alld.php";
}
},
ex: {
text: 'Não excluir pasta enviados',
btnClass: 'btn-red',
action: function (){
window.location = "lixo_alld_ex.php";
}
},
cancelar: function () {
...
if(typeof window.history.replaceState == 'function') {
        window.history.replaceState({}, "Hide", "http://athena.troiatecnologia.com.br/new_sistem/pages/mailbox/diadia.php");
}     		
</script>
