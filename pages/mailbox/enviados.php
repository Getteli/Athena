...
if (is_numeric($parametro) || !empty($mes) || !empty($dia) || !empty($ano)) {
	...
	$get = "SELECT * from agenda WHERE(remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' AND matricula_alu_agen='$parametro' OR matricula_prof_agen='$parametro' AND (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' OR MONTH(data_agen) = '$mes' AND (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' OR DAY(data_agen) = '$dia' AND (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' OR YEAR(data_agen) = '$ano' AND (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' ORDER BY id_agen DESC";
	...
	$get = "SELECT * from agenda WHERE (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' AND matricula_alu_agen='$matr' OR titulo_agen like '%$parametro%' AND (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' OR mensagem_age like '%$parametro%' AND (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' OR MONTH(data_agen) = '$mes' AND (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' OR DAY(data_agen) = '$dia' AND (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' OR YEAR(data_agen) = '$ano' AND (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' ORDER BY id_agen DESC";

}else{
	//assim que inicia, como não tem parametro, ele busca tudo
	$get = "SELECT * FROM agenda WHERE (remedio1 = 'sistema' OR remedio1 = 'turmaagendasistema') AND lixo = '0' ORDER BY id_agen DESC";
}
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 id="red-tit" class="box-title">Enviados</h3>
		...
		$tp = $tr / $total_reg; // verifica o número total de páginas
			...
			$turma = $dados["turma_aluno"];
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name"><a <?php echo "href='ler_agendad.php?id=".$id."'" ?>>
<?php
...
if(typeof window.history.replaceState == 'function') {
        window.history.replaceState({}, "Hide", "http://athena.troiatecnologia.com.br/new_sistem/pages/mailbox/enviados.php");
}     		
</script>
</body>
</html>