...
if (is_numeric($parametro) ||floor($parametro) ) {
	...
	$get = "SELECT * from aluno WHERE matricula_alu='$parametro' OR rg_alu='$parametro' OR rg_resp='$parametro' OR rg_resp2='$parametro' OR rg_respf='$parametro' OR cpf_alu='$parametro' OR cpf_resp='$parametro' OR cpf_resp2='$parametro' OR cpf_respf='$parametro' ORDER BY nome_alu";

} /* se for string */
else if ((String)$parametro) {
	
	$get="SELECT * from aluno WHERE nome_alu like '%$parametro%' OR nome_resp like '%$parametro%' OR nome_resp2 like '%$parametro%' OR nome_respf like '%$parametro%' OR email_resp like '%$parametro%' OR email_resp2 like '%$parametro%' OR email_respf like '%$parametro%' OR turma_fk like '%$parametro%' OR bairro_resp like '%$parametro%' ORDER BY nome_alu";

}else{
	//assim que inicia, como não tem parametro, ele busca tudo
	$get = "SELECT * FROM aluno ORDER BY nome_alu";
}
...
//total mostrado
$getm = "SELECT id_aluno FROM aluno ORDER BY id_aluno DESC";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Buscar aluno</li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-warning">
            <div class="box-header">
              <h3 id="red-tit" class="box-title">Buscar alunos</h3>
              <!-- php paginação aluno -->
              <?php 
...
$id = $conteudo['id_aluno'];
$matricula = $conteudo['matricula_alu'];
$nome = $conteudo['nome_alu'];
$turma = $conteudo['turma_fk'];

?>                  
        <a href="<?php echo 'alterar_aluno.php?id='.$id ?>"><div class="col-md-3 col-sm-6 col-xs-12">            
          <div class="info-box">
...
<?php
	...
	$base64 = base64_encode($photo['foto_aluno']);
   	...
   	if($nomefoto == ""){
   	echo "<img id='preview' class='bg-yellow' style='cursor: pointer; width:100%; height:99%; margin-top:-9.51px;' src='../../dist/img/add-img.png' />";   	
   	}else{
...
if(typeof window.history.replaceState == 'function') {
        window.history.replaceState({}, "Hide", "http://athena.troiatecnologia.com.br/new_sistem/pages/aluno/buscar_aluno.php");
}
</script>
</body>
</html>