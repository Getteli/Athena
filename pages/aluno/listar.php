      ...
      <div class="row">
          ...
          <div class="box box-warning">
            <div class="box-header">
              <h3 id="red-tit" class="box-title">Arquivos</h3>      
    	    </div>
    	    <div class="box-footer">	         
<?php

while($dados = mysqli_fetch_array($resultado)){
$Codigo = $dados['NmArquivo'];
$id = $dados['id'];
$nomarq = $dados['NmArquivo'];
$tipo = $dados['Tipo'];
$dt = $dados['DtHrEnvio'];
$tamanho = $dados['Tamanho'];
?>
        <div class="col-md-3 col-sm-6 col-xs-12">
         <a id="<?php echo "ex".$id ?>" style="display:none;" href="excluirarq.php?Matricula=<?php echo $matricula ?>&id=<?php echo $id ?>"></a>        
         <a id="<?php echo $id ?>" style="display:none;" target="_blank" href="ver_arquivo.php?Matricula=<?php echo $matricula ?>&id=<?php echo $id ?>"></a>
         <a href="#" onclick="alerta1(<?php echo $id ?>)">
          <div class="info-box" >
            <span class="info-box-icon bg-yellow"><i class="fa fa-files-o"></i></span>
            <div class="info-box-content">
              <span class="info-box-number" style="font-size:14px;"><?php echo mb_strimwidth($nomarq, 0,15, " ...","UTF-8"); ?></span>
              <span class="progress-description"><?php echo $tipo ?></span>
              <span class="progress-description"><?php echo $dt ?></span>              
              <span class="info-box-text"><?php echo $tamanho ?> kb <!--você pode fazer divisão por 1024 para mostrar em MB--></span>
            </div>
            <!-- /.info-box-content -->
          </div></a>
          <!-- /.info-box -->
...
return	$.confirm({
title: 'Arquivo',
content: 'Deseja realmente excluir este arquivo?',
buttons: {
Sim: {
text: 'Sim',
btnClass: 'btn-red',
...
if(typeof window.history.replaceState == 'function') {
        window.history.replaceState({}, "Hide", "http://athena.troiatecnologia.com.br/new_sistem/pages/aluno/listar.php");
} 
</script>
</body>
</html>