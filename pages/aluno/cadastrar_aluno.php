      ...
      <div class="row">
          ...
          <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">Cadastre um novo aluno</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="salvaraluno.php" id="form" name="form" method="POST" enctype="multipart/form-data" data-ls-module="form" class="form-horizontal">
              <div class="box-body">
            <div class="widget-user-image bg-yellow">
            <div id="dium">
            <div id="didois">
            <label>
              <input style="display:none" type=file id="filefoto" name="filefoto">
              <img class="img-circle" width="130" height="130" src="../../dist/img/add-img.png" alt="User Avatar">
            </label>  
            </div>  
            </div>  
            </div> 
                 <div class="form-group">     
                  <label for="inputPassword3" class="col-sm-2 control-label">Mat. automática</label>

                  <div class="col-sm-10">
                  <input type="checkbox" style="top:7.5px; padding:0 0 0 0; min-height:0;" class="checkbox" id="myCheck" value="sim" title="Matricula automática" onclick="validate()"/>                  						
		 </div>
		</div>
                <div class="form-group" id="dema">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" id="Matricula" name="Matricula" class="form-control" placeholder="Matricula" style="width:250px;">
                  </div>
                </div>                  
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="nomealu" name="NomeDoAluno" placeholder="Nome completo">
                  </div>
                </div>
                <div class="form-group">
			...
			<select type="text" name="sexo" id="sexo" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="width:100%;">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="DataNasc" data-inputmask='"mask": "99/99/9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                  </div>
                <div class="form-group">                                  
	            ...
	            <input type="text" class="form-control" name="RGAluno" data-inputmask='"mask": "99.999.999.9"' data-mask style="width:250px;">
                  </div>                 
                </div>
                <div class="form-group">                                  
	            ...
	            <input type="text" class="form-control" name="CPFAluno" data-inputmask='"mask": "999.999.999-99"' data-mask style="width:250px;">
                  </div>                 
                </div>    
                <div class="form-group">                                   
                  <label for="inputPassword3" class="col-sm-2 control-label">Arquivo <i class="text-red"></i></label>
                  ...
                  <div class="col-sm-10">
                    ...
                    <label class="btn btn-block btn-warning" for='file'>Selecionar um arquivo &#187;</label>                
	            <input id="file" id="file" name="file[]"  multiple  type="file" style="width:10%;"/>
                  </div>                 
                </div>    
                <div class="form-group">                                  
			 ...
			 <option value="0">Selecione uma turma</option>
              ...
              <h3>Filiação</h3>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="nomer1" name="NomeResp" placeholder="Nome completo do primeiro responsável">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="cpfr1" name="CPFResp" placeholder="CPF do primeiro responsável" data-inputmask='"mask": "999.999.999-99"' data-mask style="width:250px;">
                  </div>
                </div>  
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="rgr1" name="RGResp" placeholder="RG do primeiro responsável" data-inputmask='"mask": "99.999.999.9"' data-mask style="width:250px;">
                  </div>
                </div>   
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Nascimento <i class="text-blue">*</i></label>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="DataNascResp" data-inputmask='"mask": "99/99/9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div>                                                         
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" id="emailr1" name="Email" placeholder="Email do primeiro responsável">
                  </div>
                </div>  
                <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="Celular" data-inputmask='"mask": "(99)9 9999-9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div>
                <!--segundo responsável-->
              <div class="box-footer"> </div>  
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="nomer2" name="NomeResp2" placeholder="Nome completo do segundo responsável">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">CPF <i class="text-blue"></i></label>
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="cpfr2" name="CPFResp2" placeholder="CPF do segundo responsável" data-inputmask='"mask": "999.999.999-99"' data-mask style="width:250px;">
                  </div>
                </div>  
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">RG <i class="text-blue"></i></label>
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="rgr2" name="RGResp2" placeholder="RG do segundo responsável" data-inputmask='"mask": "99.999.999.9"' data-mask style="width:250px;">
                  </div>
                </div>   
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Nascimento <i class="text-blue"></i></label>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="DataNascResp2" data-inputmask='"mask": "99/99/9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div>                                                         
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" id="emailr2" name="Email2" placeholder="Email do segundo responsável">
                  </div>
                </div>  
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Celular <i class="text-blue"></i></label>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="Celular2" data-inputmask='"mask": "(99)9 9999-9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div>
              <!--Endereço-->
              <div class="box-footer"> </div>  
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="tel" name="TelFixo" data-inputmask='"mask": "(99) 9999-9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div>    
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" name="LogradouroResp" placeholder="Endereço completo">
                  </div>
                </div>  
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" name="NumResp" placeholder="número do endereço" style="width:250px;">
                  </div>
                </div> 
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" name="BairroResp" placeholder="Bairro completo" >
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="CEPResp" data-inputmask='"mask": "99999-999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" name="CidadeResp" placeholder="Cidade completa" >
                  </div>
                </div>                
                </div>
               ...
               <h3>Financeiro</h3>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="nomerf" name="NomeRespf" placeholder="Nome completo do responsável financeiro">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">CPF <i class="text-blue">*</i></label>
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="cpfrf" name="CPFRespf" placeholder="CPF do responsável financeiro" data-inputmask='"mask": "999.999.999-99"' data-mask style="width:250px;">
                  </div>
                </div>  
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">RG <i class="text-blue">*</i></label>
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="rgrf" name="RGRespf" placeholder="RG do responsável financeiro" data-inputmask='"mask": "99.999.999.9"' data-mask style="width:250px;">
                  </div>
                </div>   
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Nascimento <i class="text-blue">*</i></label>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="DataNascRespf" data-inputmask='"mask": "99/99/9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div>                                                         
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" id="emailrf" name="Emailf" placeholder="Email do responsável financeiro">
                  </div>
                </div>  
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Celular <i class="text-blue">*</i></label>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="Celularf" data-inputmask='"mask": "(99)9 9999-9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div>              
              </div>
              ...
              <h3>Segurança</h3>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" name="RespSegNome1" placeholder="Nome completo do primeiro resp. de segurança">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="RespSegTel1" data-inputmask='"mask": "(99)9 9999-9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div> 
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <span class="help-block" id="war-turm" style="display:none;"><i class="fa fa-bell-o text-yellow"> Por favor preencha este campo</i></span>                  
                    <input type="text" class="form-control" name="RespSegCpf1" placeholder="CPF do primeiro resp. de segurança " data-inputmask='"mask": "999.999.999-99"' data-mask style="width:250px;">
                  </div>
                </div>  
              ...
              <div class="box-footer"></div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <span class="help-block" id="war-turm" style="display:none;"><i class="fa fa-bell-o text-yellow"> Por favor preencha este campo</i></span>                  
                    <input type="text" class="form-control" name="RespSegNome2" placeholder="Nome completo do segundo resp. de segurança">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Contato<i class="text-blue"></i></label>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="RespSegTel2" data-inputmask='"mask": "(99)9 9999-9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div> 
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <span class="help-block" id="war-turm" style="display:none;"><i class="fa fa-bell-o text-yellow"> Por favor preencha este campo</i></span>                  
                    <input type="text" class="form-control" name="RespSegCpf2" placeholder="CPF do segundoresp. de segurança " data-inputmask='"mask": "999.999.999-99"' data-mask style="width:250px;">
                  </div>
                </div>               
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                ...
                <button type="button" onclick="alerta1()" class="btn btn-warning pull-right">Cadastrar</button>
              </div>
              <!-- /.box-footer -->
            </form>  
	</div>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#">O campo marcado com <i class="text-yellow">*</i> será obrigatório, caso o Checkbox não esteja marcado.</i></a></li>
...
if (matr == "") {
document.getElementById("war-mat").style.display="inline";
form.Matricula.focus();
return true;
}else{
document.getElementById("war-mat").style.display="none";
}
}
