...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Professor
        <small>Cadastro de professor</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../inicio.php"><i class="fa fa-dashboard"></i> Início</a></li>
        <li class="active">Cadastrar professor</li>
      </ol>
    </section>
      ...
      <div class="row">
          ...
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Cadastre um novo professor</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="salvarprof.php" id="form" name="form" method="POST" enctype="multipart/form-data" data-ls-module="form" class="form-horizontal">
              <div class="box-body">
            ...
            <label>
              ...
              <img class="img-circle" width="130" height="130" src="../../dist/img/add-img2.png" alt="User Avatar">
            </label>  
            </div>  
            </div>  
            </div> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="nomeprof" name="NomeDoProf" placeholder="Nome completo">
                  </div>
                </div>
                <div class="form-group">
			...
			<select type="text" name="sexo" id="sexo" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="width:100%;">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="Dt_Nasc_Prof" data-inputmask='"mask": "99/99/9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                  </div>
                <div class="form-group">                                  
	            ...
	            <input type="text" class="form-control" name="RGProf" data-inputmask='"mask": "99.999.999.9"' data-mask style="width:250px;">
                  </div>                 
                </div>
                <div class="form-group">                                  
	            ...
	            <input type="text" class="form-control" name="CPFProf" data-inputmask='"mask": "999.999.999-99"' data-mask style="width:250px;">
                  </div>                 
                </div>    
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="forma" name="Formacao" placeholder="Formação do docente">
                  </div>
                </div>   
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <span class="help-block" id="war-nr1" style="display:none;"><i class="fa fa-bell-o text-yellow"> Por favor preencha este campo</i></span>                  
                    <input type="text" class="form-control" id="disc" name="Disciplina" placeholder="Disciplina que o docente exercitará">
                  </div>
                </div>                                
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" id="email" name="EmailProf" placeholder="Email do docente">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="tel" name="Telefone" data-inputmask='"mask": "(99) 9999-9999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" name="Logradouro" placeholder="Endereço completo">
                  </div>
                </div>                  
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" name="Numero" placeholder="número do endereço" style="width:250px;">
                  </div>
                </div>                 
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" name="Bairro" placeholder="Bairro completo" >
                  </div>
                </div>                
                <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="Cep" data-inputmask='"mask": "99999-999"' data-mask style="width:213px;">
                </div>                  
                </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="email" class="form-control" name="Cidade" placeholder="Cidade completa" >
                  </div>
                </div>                
              ...
              <div class="box-footer">
                ...
                <button type="button" onclick="alerta1()" class="btn btn-danger pull-right">Cadastrar</button>
              </div>
              <!-- /.box-footer -->
            </form>  
	</div>
