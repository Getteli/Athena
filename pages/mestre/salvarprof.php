...
$sql = "SELECT matricula_prof FROM professor WHERE matricula_prof ='$matricula'";
...
echo "<script type='text/javascript'>
  $.confirm({
    title: 'Erro!',
    content: 'Está matricula já está cadastrada',
    buttons: {
      Ok: {
      text: 'Ok',
      btnClass: 'btn-blue',
...
$dateFormat = inverteData($dt_nasc);
  ...
  $binariofoto = mysqli_real_escape_string($con,$binariofoto);
    ...
    $query = mysqli_query($con, "insert into professor values('','$matricula','$nome_prof','$sexo','$file_namefoto','$binariofoto','$file_typefoto','$dateFormat','$cpf_prof','$rg_prof','$email_prof','$cep','$logradouro','$cidade','$bairro','$numero','$celular','$telefone','$disciplina','$formacao');");
    ...
    if ($query) {
     iconv_set_encoding("internal_encoding", "UTF-8");    
      $headers = "MIME-Version: 1.1\r\n";
          ...
          $.confirm({
              title: 'Sucesso!',
              content: 'Novo docente adicionado com sucesso',
              buttons: {
                  Ok: {
                      text: 'Ok',
                      btnClass: 'btn-blue',
                      keys: ['enter', 'shift'],
                      action: function(){
                          window.location = 'cadastrar_professor.php';
                      }
                  }
              }
          });
    ...
    die("Erro:1 ".mysqli_error($con));
  }
  
  }else if ($file_namefoto == ""){
  
  $query = mysqli_query($con, "insert into professor values('','$matricula','$nome_prof','$sexo','','','','$dateFormat','$cpf_prof','$rg_prof','$email_prof','$cep','$logradouro','$cidade','$bairro','$numero','$celular','$telefone','$disciplina','$formacao');");
    ...
    die("Erro:2 ".mysqli_error($con));
  }
  
}else{
    die("Erro:3 ".mysqli_error($con));
  }
